...
const Princing = () => {
  return (
    <div>
      <BannerPage
        titleBanner="30 days money back guarantee"
        subtitleBanner="No Extra Fees. Friendly Support"
      />
      <div>
        <div className="flex flex-wrap items-center justify-center gap-[25px] my-14">
